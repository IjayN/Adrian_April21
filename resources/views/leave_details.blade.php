                                ...
                                <div class="body">
                                    ...
                                    <center>
                                        <div class="form-group ">
                                            ...
                                            <a href="{{route('leave-app',$leave->id)}}"
                                            ...
                                            <form id="dform" action="{{route('leave-app',$leave->id)}}" method="POST"
                                                  style="display: none;">
                                            ...
                                            <div class="modal-dialog modal-dialog-cente red" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{route('leave->rej',$leave->id)}}" method="POST">
